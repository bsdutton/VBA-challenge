...
### LOOPS REQUIRED
1) FOR EACH SHEET
  * COUNTER VARIABLE FOR EACH SHEET NUMBER
2) FOR EACH TICKER SYMBOL
  * COUNTER VARIABLE FOR EACH TICKER SYMBOL
3) FOR YEARLY CHANGE FROM BEGINNING OF YEAR TO THE END OF THE YEAR.
  * 

### VARIABLES REQUIRED
1) a for sheet counter
