VBA-Challenge_alphabetical_module-5_for_solution
Option Explicit
...
Dim i As Integer    ' for loops through ticker
...
'            Set ticker_range = Worksheets(a).Range(Cells(i, 3))
'            min_value = Cells(i, 3).Value  ' just to test cell location
'            min_value = Application.WorksheetFunction.Min(Range(Cells(i, 3), Cells(i - row_count, 6)))
'            max_value = Application.WorksheetFunction.Max(Range(Cells(i, 3), Cells(i - row_count, 6)))
'            yearly_change1 = max_value - min_value
'            percentage_change1 = (yearly_change1 / min_value) * 100
...
'                Range("J" & Summary_Table_Row).Value = yearly_change1
'                Range("K" & Summary_Table_Row).Value = percentage_change1
